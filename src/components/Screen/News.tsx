        ...
        <div id="main-content">
          ...
          <div className="Container">
            <div className="Container-P">
              ...
              <h5>
                La COOPDGII honra a uno de sus próceres y valiente estratega en
                la lucha por la Independencia Nacional, Matías Ramón Mella, hoy
            ...
            <div className="Container-P">
              ...
              <h5>
                La COOPDGII se suma a la conmemoración de un año más del
                Natalicio Juan Pablo Duarte Y Diez, nuestro padre de la Patria a
                celebrarse el
              </h5>
              <br />
              <a
            ...
            <div className="Container-P">
              ...
              <h5>
                La Salud es responsabilidad de todos. La COOPDGII consciente de
                la situación actual en relación al COVID-19 motivamos a nuestra
                base social, directivos y empleados a
              </h5>
              <br />
              <a
                className="elementor-post__read-more"
